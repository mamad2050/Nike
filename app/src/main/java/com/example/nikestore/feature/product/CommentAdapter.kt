...
class CommentAdapter : RecyclerView.Adapter<CommentAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
       return Holder(LayoutInflater.from(parent.context).inflate(R.layout.item_comment,parent,false))
    }
    ...
    override fun getItemCount() = if (comments.size > 3) 3 else comments.size
